              ...
              <div className="p-8 flex flex-col gap-10 flex-1">
                ...
                <div className="mt-auto pt-10">
                  ...
                  <div className="flex items-center gap-4">
                    <a href="https://www.linkedin.com/in/amitinnovatesux/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-12 h-12 rounded-full border border-line bg-surface flex items-center justify-center hover:border-ink hover:bg-ink hover:text-background transition-all">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
                    </a>
                    <a href="https://www.behance.net/amittadvi" target="_blank" rel="noopener noreferrer" aria-label="Behance" className="w-12 h-12 rounded-full border border-line bg-surface flex items-center justify-center hover:border-ink hover:bg-ink hover:text-background transition-all">
                    ...
                    <a href="https://dribbble.com/Scyla_FX1412" target="_blank" rel="noopener noreferrer" aria-label="Dribbble" className="w-12 h-12 rounded-full border border-line bg-surface flex items-center justify-center hover:border-ink hover:bg-ink hover:text-background transition-all">
